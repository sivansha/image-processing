...
ds, ls, img_YCbCr_prediction = EstMotion(img_YCbCr_next, img_YCbCr_current, CF1, p=7, step=16)

img_YCbCr_diff = img_YCbCr_next - img_YCbCr_prediction

print("Prediction error for CF1: {0}".format(get_entropy(img_YCbCr_diff)))
plt.imshow(img_YCbCr_prediction, cmap = 'gray')
plt.show()
...
print("Prediction error for CF2: {0}".format(get_entropy(img_YCbCr_diff)))
plt.imshow(img_YCbCr_prediction, cmap = 'gray')
plt.show()
